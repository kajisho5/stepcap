...
![stepcap: record, then page through the generated guide](docs/demo/demo.gif)

| Generated `guide.html` (light / dark, TOC, print CSS) | `stepcap edit` (reorder, rename, blur) |
|---|---|
| ![guide.html](docs/demo/guide-html.png) | ![edit UI](docs/demo/edit-ui.png) |

Every screenshot has a numbered double ring on the click; drags get an arrow, scrolls a
direction arrow, shortcuts a key-cap label. `--zoom 640` makes the crop around the click
the main image and adds a full-screen thumbnail:

| Full screen (`step-drag`) | `--zoom 640` |
|---|---|
| ![drag step](docs/demo/step-drag.png) | ![zoomed step](docs/demo/step-zoom.png) |
...
- **Local editor** (`stepcap edit`): drag to reorder, delete, rename, describe, blur
